...
namespace WindowsFormsApp1 {
    ...
    public partial class dsApp : global::System.Data.DataSet {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductoRow AddProductoRow(string Nombre, string Marca, decimal Precio, int Stock, string Observacion, string Foto, int IdCategoria) {
        ...
        public partial class ProductoRow : global::System.Data.DataRow {
            ...
            public string Observacion {
                get {
                    try {
                        return ((string)(this[this.tableProducto.ObservacionColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Observacion\' de la tabla \'Producto\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tableProducto.ObservacionColumn] = value;
                }
            }
            ...
            public bool IsObservacionNull() {
                return this.IsNull(this.tableProducto.ObservacionColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetObservacionNull() {
                this[this.tableProducto.ObservacionColumn] = global::System.Convert.DBNull;
            }
...
namespace WindowsFormsApp1.dsAppTableAdapters {
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Producto] WHERE (([IdProducto] = @Original_IdProducto) AND ([Nombre] = @Original_Nombre) AND ((@IsNull_Marca = 1 AND [Marca] IS NULL) OR ([Marca] = @Original_Marca)) AND ([Precio] = @Original_Precio) AND ([Stock] = @Original_Stock) AND ((@IsNull_Foto = 1 AND [Foto] IS NULL) OR ([Foto] = @Original_Foto)) AND ((@IsNull_IdCategoria = 1 AND [IdCategoria] IS NULL) OR ([IdCategoria] = @Original_IdCategoria)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Producto] ([Nombre], [Marca], [Precio], [Stock], [Observacion], [Foto], [IdCategoria]) VALUES (@Nombre, @Marca, @Precio, @Stock, @Observacion, @Foto, @IdCategoria);
SELECT IdProducto, Nombre, Marca, Precio, Stock, Observacion, Foto, IdCategoria FROM Producto WHERE (IdProducto = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Producto] SET [Nombre] = @Nombre, [Marca] = @Marca, [Precio] = @Precio, [Stock] = @Stock, [Observacion] = @Observacion, [Foto] = @Foto, [IdCategoria] = @IdCategoria WHERE (([IdProducto] = @Original_IdProducto) AND ([Nombre] = @Original_Nombre) AND ((@IsNull_Marca = 1 AND [Marca] IS NULL) OR ([Marca] = @Original_Marca)) AND ([Precio] = @Original_Precio) AND ([Stock] = @Original_Stock) AND ((@IsNull_Foto = 1 AND [Foto] IS NULL) OR ([Foto] = @Original_Foto)) AND ((@IsNull_IdCategoria = 1 AND [IdCategoria] IS NULL) OR ([IdCategoria] = @Original_IdCategoria)));
SELECT IdProducto, Nombre, Marca, Precio, Stock, Observacion, Foto, IdCategoria FROM Producto WHERE (IdProducto = @IdProducto)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp1.Properties.Settings.Default.ParcialConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT * FROM Producto WHERE Precio < 2500 AND Stock > 5";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO [Producto] ([Nombre], [Marca], [Precio], [Stock], [IdCategoria]) VALU" +
                "ES (@Nombre, @Marca, @Precio, @Stock, @IdCategoria);\r\n";
            ...
            this._commandCollection[2].CommandText = "UPDATE [Producto] SET [Nombre] = @Nombre, [Marca] = @Marca, [Precio] = @Precio, [" +
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Marca", global::System.Data.SqlDbType.VarChar, 100, global::System.Data.ParameterDirection.Input, 0, 0, "Marca", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IdProducto", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "IdProducto", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "SELECT * FROM Producto WHERE Precio < 2500 AND Stock > 5 AND IdProducto = @idprod" +
                "ucto";
            ...
            this._commandCollection[4].CommandText = "DELETE FROM Producto WHERE IdProducto = @idproducto";
            this._commandCollection[4].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@idproducto", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "IdProducto", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(dsApp.ProductoDataTable dataTable) {
        ...
        public virtual dsApp.ProductoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsApp.ProductoDataTable dataTable = new dsApp.ProductoDataTable();
        ...
        public virtual int FillBy(dsApp.ProductoDataTable dataTable, int idproducto) {
        ...
        public virtual dsApp.ProductoDataTable GetDataById(int idproducto) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(idproducto));
            dsApp.ProductoDataTable dataTable = new dsApp.ProductoDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsApp.ProductoDataTable dataTable) {
        ...
        public virtual int Delete(int Original_IdProducto, string Original_Nombre, string Original_Marca, decimal Original_Precio, int Original_Stock, string Original_Foto, global::System.Nullable<int> Original_IdCategoria) {
            ...
            if ((Original_IdCategoria.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[9].Value = ((int)(Original_IdCategoria.Value));
            }
            else {
        ...
        public virtual int Insert(string Nombre, string Marca, decimal Precio, int Stock, string Observacion, string Foto, global::System.Nullable<int> IdCategoria) {
            if ((Nombre == null)) {
        ...
        public virtual int Update(string Nombre, string Marca, decimal Precio, int Stock, string Observacion, string Foto, global::System.Nullable<int> IdCategoria, int Original_IdProducto, string Original_Nombre, string Original_Marca, decimal Original_Precio, int Original_Stock, string Original_Foto, global::System.Nullable<int> Original_IdCategoria, int IdProducto) {
            if ((Nombre == null)) {
                throw new global::System.ArgumentNullException("Nombre");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Marca, decimal Precio, int Stock, string Observacion, string Foto, global::System.Nullable<int> IdCategoria, int Original_IdProducto, string Original_Nombre, string Original_Marca, decimal Original_Precio, int Original_Stock, string Original_Foto, global::System.Nullable<int> Original_IdCategoria) {
            return this.Update(Nombre, Marca, Precio, Stock, Observacion, Foto, IdCategoria, Original_IdProducto, Original_Nombre, Original_Marca, Original_Precio, Original_Stock, Original_Foto, Original_IdCategoria, Original_IdProducto);
        }
        ...
        public virtual int Add(string Nombre, string Marca, decimal Precio, int Stock, global::System.Nullable<int> IdCategoria) {
        ...
        public virtual int Edit(string Nombre, string Marca, decimal Precio, int Stock, global::System.Nullable<int> IdCategoria, int IdProducto) {
            ...
            command.Parameters[5].Value = ((int)(IdProducto));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
        ...
        public virtual int Remove(int idproducto) {
